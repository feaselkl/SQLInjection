<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SPDriven.aspx.cs" Inherits="SQLInjectionWorkbench.SPDriven" %>
...
<body>
    ...
    <div>
        <p>This is a test of a static stored procedure.  Note that stored procedures practically beg to be parameterized in the data layer (one nice advantage
        to using them in the first place).  Try what you will, but you cannot use SQL injection to attack this page.</p>
    </div>
    <div>
