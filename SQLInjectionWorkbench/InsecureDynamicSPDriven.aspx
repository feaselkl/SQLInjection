<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsecureDynamicSPDriven.aspx.cs" Inherits="SQLInjectionWorkbench.InsecureDynamicSPDriven" %>
...
<body>
    ...
    <div>
        <p>This is a test of unsafe dynamic SQL in a stored procedure which is susceptible to SQL injection.  Feel free to test various techniques, see what you can do, 
        and generally try to break the system.  Before doing that, I would recommend that you:</p>
        <ol>
